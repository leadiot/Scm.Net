...
namespace Com.Scm.Addon
{
    ...
    {
        private static List<Manifest> _Addons = new List<Manifest>();
        ...
        public static T GetAddon<T>(string name)
        {
            var type = typeof(T);
        ...
        public static T GetAddonByUri<T>(string uri)
        {
            var type = typeof(T);
