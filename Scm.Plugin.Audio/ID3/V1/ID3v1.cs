...
namespace Com.Scm.Audio.ID3.V1
{
    /// <summary>
    ...
    public class ID3v1
    {
        ...
        private TextEncodings _Encodings = TextEncodings.GB2312;
		...
		public void Load()
        {
            ...
            _Title = FS.ReadText(30, _Encodings);
            FS.Seek(-95, SeekOrigin.End);
            _Artist = FS.ReadText(30, _Encodings);
            FS.Seek(-65, SeekOrigin.End);
            _Album = FS.ReadText(30, _Encodings);
            FS.Seek(-35, SeekOrigin.End);
            _Year = FS.ReadText(4, _Encodings);
            FS.Seek(-31, SeekOrigin.End);
            _Comment = FS.ReadText(28, _Encodings);
