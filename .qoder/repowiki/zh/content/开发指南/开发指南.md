...
## 更新摘要
**所做更改**
- 更新以反映 Wiki 文档系统的重构：开发指南相关的完整文档已被删除，当前仅保留核心开发指导说明
- 简化文档结构，聚焦核心开发流程和配置说明
- 移除详细的子系统文档，保留必要的架构概览和配置说明
- 更新项目结构图以反映当前的简化架构
...
## 简介
本开发指南面向 Scm.Net 项目，目标是帮助开发者快速搭建开发环境、理解项目架构与模块职责、掌握构建与调试流程。Scm.Net 是一款基于 .NET 10 的后端快速开发框架，采用多项目解决方案组织，结合 Swagger 文档、JWT 认证、SqlSugar ORM、Serilog 日志、Quartz 定时任务、SignalR 实时通信等技术栈。

**重要说明**：由于 Wiki 文档系统已重构，当前仅保留核心开发指导说明，详细的子系统文档已被移除。
