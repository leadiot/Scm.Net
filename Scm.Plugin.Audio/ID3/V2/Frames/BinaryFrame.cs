 ...
 */
namespace Com.Scm.Audio.ID3.ID3v2Frames.Frames
{
    /// <summary>
    ...
    public class PrivateFrame : BinaryFrame
    {
        ...
        public new MemoryStream Data
        {
            ...
            set
            {
                ...
                if (FrameID == "UFID" && value.Length > 64)
    ...
    public class DataWithSymbolFrame : PrivateFrame
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (((DataWithSymbolFrame)obj).OwnerIdentifier == OwnerIdentifier &&
                ((DataWithSymbolFrame)obj).FrameID == FrameID)
                return true;
            else
                return false;
        }
    ...
    public class AudioEncryptionFrame : PrivateFrame
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (((AudioEncryptionFrame)obj).OwnerIdentifier == OwnerIdentifier)
                return true;
            else
                return false;
        }
    ...
    public class GeneralFileFrame : BaseFileFrame
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (FrameID != ((GeneralFileFrame)obj).FrameID)
                return false;

            if (((GeneralFileFrame)obj)._Description == _Description)
                return true;
    ...
    public class AttachedPictureFrame : BaseFileFrame
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (_PictureType == PictureTypes.FileIcon ||
                _PictureType == PictureTypes.OtherFileIcon)
                if (((AttachedPictureFrame)obj)._PictureType == _PictureType)
                    return true;
