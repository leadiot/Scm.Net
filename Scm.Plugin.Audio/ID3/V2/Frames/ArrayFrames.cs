...
namespace Com.Scm.Audio.ID3.ID3v2Frames.Frames
{
    ...
    public class SynchronisedText : TermOfUseFrame
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (((SynchronisedText)obj)._Language == _Language &&
                ((SynchronisedText)obj).ContentDescriptor == ContentDescriptor)
                return true;
            else
                return false;
        }
    ...
    public class Syllable : IComparable, ILengthable
    {
        ...
        {
            if (_Time > ((Syllable)obj)._Time)
                return 1;
            else if (_Time < ((Syllable)obj)._Time)
                return -1;
            else
                return 0;
        }
    ...
    public class TempoCode : IComparable, ILengthable
    {
        ...
        public int CompareTo(object obj)
        {
            if (Equals(obj))
                return 0;
            else if (_Time > ((TempoCode)obj)._Time)
                return 1;
            else
                return -1;
        }
    ...
    public class Equalisation : Frame
    {
        ...
        public Equalisation(FrameFlags Flags, byte AdjustmentBits)
            : base("EQUA", Flags)
        {
            AdjustmentLength = AdjustmentBits;
    ...
    public class FrequencyAdjustmentFrame : ILengthable, IComparable
    {
        ...
        public int CompareTo(object obj)
        {
            return _Frequency - ((FrequencyAdjustmentFrame)obj)._Frequency;
        }
    }
