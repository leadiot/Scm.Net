...
namespace Com.Scm.Audio.ID3.ID3v2Frames.Frames
{
    ...
    public class RelativeVolumeFrame : Frame
    {
            ...
            : base("RVAD", Flags)
        {
            ...
            _IncDec = IncDec;
            BitsForVolumeDescription = BitForVolumeDescription;
        }
        ...
        public override MemoryStream FrameStream(int MinorVersion)
        {
            ...
            for (int i = 0; i < 12; i++)
            {
                Buf = ToByteArray(_Descriptors[i], DesLength);
