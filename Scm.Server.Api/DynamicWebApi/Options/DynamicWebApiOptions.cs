...
namespace Com.Scm.DynamicWebApi.Options
{
    public class DynamicWebApiOptions
    {
        public DynamicWebApiOptions()
        {
            //RemoveControllerPostfixes = new List<string>() { "ApplicationService", "AppService", "ApiService", "Service", };
            RemoveControllerPostfixes = new List<string>() { "ApplicationService", "Service", };
