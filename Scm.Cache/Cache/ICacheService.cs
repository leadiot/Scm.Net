namespace Com.Scm.Cache
{
    ...
    public interface ICacheService
    {
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        T GetCache<T>(string key) where T : class, new();
        ...
        /// <param name="key"></param>
        /// <param name="value"></param>
        /// <param name="timeoutSeconds">间隔秒数</param>
        /// MemoryCacheService.Default.SetCache("test", "RedisCache works!", 30);
        void SetCache(string key, object value, int timeoutSeconds);
        ...
        void SetCache(string key, object value, TimeSpan t);
