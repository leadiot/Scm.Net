...
using Com.Scm.Token;
using Com.Scm.Ur.UserOidc.Dvo;
using Com.Scm.Utils;
using Microsoft.AspNetCore.Mvc;

namespace Com.Scm.Ur.UserOidc
{
    /// <summary>
    /// 三方登录服务接口
    /// </summary>
    ...
    public class ScmUrUserOidcService : ApiService
    {
        ...
        /// <returns></returns>
        public ScmUrUserOidcService(IJwtTokenHolder jwtHolder,
        ...
        /// <returns></returns>
        public async Task<ScmSearchPageResponse<UserOidcDvo>> GetPagesAsync(ScmSearchPageRequest request)
        {
        ...
        private void Prepare(List<UserOidcDvo> list)
        {
        ...
        /// <returns></returns>
        [HttpGet("{id}")]
        public async Task<UserOidcDvo> GetViewAsync(long id)
        {
            return await _thisRepository
                .AsQueryable()
                .Where(a => a.id == id)
        ...
        public async Task<bool> AddAsync(UserOidcDto model)
        {
            ...
            return await _thisRepository.InsertAsync(model.Adapt<UserOidcDao>());
        }
        ...
        public async Task<BindResponse> DoBindAsync(BindRequest request)
        {
            ...
            var userOAuthDao = new UserOidcDao();
