...
namespace Com.Scm.Audio.ID3.ID3v2Frames.Frames
{
    ...
    public class PopularimeterFrame : TextOnlyFrame
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (((PopularimeterFrame)obj).EMail == EMail)
                return true;
            else
                return false;
        }
    ...
    public class UserTextFrame : TextFrame
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (FrameID == ((UserTextFrame)obj).FrameID
                && _Description == ((UserTextFrame)obj)._Description)
                return true;
            else
                return false;
        }
    ...
    public class TermOfUseFrame : TextFrame
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (((TermOfUseFrame)obj)._Language == _Language &&
                ((TermOfUseFrame)obj).FrameID == FrameID)
                return true;
            else
                return false;
        }
    ...
    public class LinkFrame : TextFrame
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (((LinkFrame)obj)._FrameIdentifier == _FrameIdentifier)
                return true;
            else
                return false;
        }
    ...
    public class TextWithLanguageFrame : UserTextFrame
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (((TextWithLanguageFrame)obj).FrameID == FrameID &&
                ((TextWithLanguageFrame)obj)._Language == _Language &&
                ((TextWithLanguageFrame)obj)._Description == _Description)
                return true;
            else
                return false;
        }
