...
- [ITreeDao.cs](file://Scm.Server.Dao/Dao/ITreeDao.cs)
...
## 更新摘要
**所做更改**
- 新增 IModelHelper 接口设计和 ScmServerHelper 统一注册机制
- 完善实体继承体系：ScmDao 基类及 ScmCreateDao/ScmUpdateDao/ScmDataDao 专用基类
- 扩展接口体系：ICreateDao/IUpdateDao/IDeleteDao/IStatusDao/ISystemDao/ISortableDao/ITreeDao
- 增强数据库抽象层：ScmDbHelper 实现 IModelHelper 接口
- 完善仓储模式：SugarRepository<T> 的过滤器和 AOP 处理机制
- 新增数据迁移管理：版本控制和脚本执行机制
...
- 抽象与基类
  ...
  - 实体基类体系：ScmDao 及其专用派生类
- 接口定义体系
  - 生命周期接口：ICreateDao/IUpdateDao/IDeleteDao/IStatusDao
  - 系统属性接口：ISystemDao/ISortableDao/ITreeDao
- 组件关系概览
...
- [ITreeDao.cs:3-7](file://Scm.Server.Dao/Dao/ITreeDao.cs#L3-L7)
...
- 实体基类与接口体系
  ...
  - ScmCreateDao/ScmUpdateDao/ScmDataDao：专用实体基类
  - ICreateDao/IUpdateDao/IDeleteDao/IStatusDao：标准生命周期接口
  - ISystemDao/ISortableDao/ITreeDao：系统属性和树形结构接口
...
#### 专用实体基类
- ScmCreateDao：仅包含创建信息
  - create_time：创建时间
  - create_user：创建用户
- ScmUpdateDao：仅包含更新信息
  - update_time：更新时间
  - update_user：更新用户
- ScmDataDao：包含完整生命周期和状态
  - row_status：数据状态
  - create_time/create_user：创建信息
  - update_time/update_user：更新信息
...
- ScmCreateDao：create_time/create_user
- ScmUpdateDao：update_time/update_user
- ScmDataDao：row_status + 生命周期字段
- ICreateDao/IUpdateDao/IDeleteDao/IStatusDao：标准生命周期字段
- ISystemDao/ISortableDao/ITreeDao：系统属性和树形结构字段
...
- [ScmCreateDao.cs:17-25](file://Scm.Server.Dao/Dao/ScmCreateDao.cs#L17-L25)
- [ScmUpdateDao.cs:17-25](file://Scm.Server.Dao/Dao/ScmUpdateDao.cs#L17-L25)
- [ScmDataDao.cs:35-66](file://Scm.Server.Dao/Dao/ScmDataDao.cs#L35-L66)
...
- [ITreeDao.cs:5](file://Scm.Server.Dao/Dao/ITreeDao.cs#L5)